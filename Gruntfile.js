// Generated on 2016-01-22 using generator-ep-scaffold 3.0.0-rc8
'use strict';
      ...
      scripts: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
               [
                 '<%= yeoman.client %>/{shared,account,admin,constants,components,controllers,modules}/**/!(*.spec|*.mock).js',
